...
const answers = [
  ...
  {
    keys: ["回程", "回去", "返程"],
    text: "請切換到「回程」模式，再選擇要返回高鐵苗栗站或臺鐵豐富站，系統會更新步驟與 Google Maps 連結。"
  },
  {
    keys: ["下雨", "雨", "天氣"],
...
["廁所在哪裡？", "我要怎麼回程？", "找不到集合點怎麼辦？"].forEach((question) => {
...
addMessage("你好，這裡是後龍好望角音樂祭會場導覽。你可以詢問交通、報到、回程、廁所或集合點，我會用繁體中文回答。");
render();
